...
def resource_sufficient(order_ingredients):
    """Returns True when order can be made and False when there are insufficient ingredients."""
...
def process_coins():
    """ Returns the total calculated in dollars from coins inserted. """
...
def transaction_success(money_received, drink_cost):
    """Return True when payment is accepted. Return False when there are insufficient funds."""
